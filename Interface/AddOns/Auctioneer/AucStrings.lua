...
AuctioneerLocalizations = {
	...
	csCZ = {
		...
		["ConstantsCritical"]	= "VÁŽNÉ: Soubor Auctioneera \"SavedVariables\" je už naplněn z %.3f%%!";
		["ConstantsMessage"]	= "Soubor Auctioneera \"SavedVariables\" je už naplněn z %.3f%%!";
		["ConstantsWarning"]	= "VAROVÁNÍ: Soubor Auctioneera \"SavedVariables\" je už naplněn z %.3f%%!";
		["FrmtActClearall"]	= "Mazu vsechna aukcni data k %s";
		["FrmtActClearFail"]	= "Nelze najit předmět: %s";
		["FrmtActClearOk"]	= "Smazana data k předmětu: %s";
		...
		["FrmtActDisable"]	= "Nezobrazuji data předmětu o %s";
		["FrmtActEnable"]	= "Zobrazuji data předmětu o %s";
		...
		["OptAuctionDuration"]	= "(trvani||12h||24h||48h)";
		...
		["CmdAuctionDuration1"]	= "12hod";
		["CmdAuctionDuration2"]	= "24hod";
		["CmdAuctionDuration3"]	= "48hod";
		...
		["ConfirmBidBuyout"]	= "Určitě chceš %s\n%dx%s pro:";
		...
		["HelpAskPriceSend"]	= "Ručně odeslat hráči výsledek dotazu \"AskPrice\".";
		...
		["HelpAskPriceWhispers"]	= "Přepíná zobrazení odchozích zpráv \"AskPrice\" (viditelné nebo neviditelné).";
		["HelpAskPriceWord"]	= "Přidat nebo změnit vlastní \"SmartWords\" pro \"AskPrice\".";
		["HelpAuctionClick"]	= "Umoznuje automaticky vlozit předmět z inventare do aukce pomoci Alt-Kliku a založit pro něj aukci.";
		...
		["HelpFinishSound"]	= "Nastaví zda se má po skončení skenu zahrát zvuk.";
		...
		["BuySortTooltip"]	= "Setřídit stránku výsledků podle výkupní ceny (se SHIFT-em bude třídit podle názvu předmětu)";
		["ClearTooltip"]	= "Vymazat všechny hodnoty z políček pro vyhledávání.";
		...
		["UiBuyoutPriceTooLowError"]	= "(Příliš nízká)";
		...
		["UiSearchForLabel"]	= "Vyhledat předmět:";
		["UiSearchTypeBids"]	= "NaBIDky";
		["UiSearchTypeBuyouts"]	= "Výkupy";
		["UiSearchTypeCompetition"]	= "Konkurence";
		["UiSearchTypePlain"]	= "Předmět";
		["UiStacksLabel"]	= "Balíčky";
		["UiStackTooBigError"]	= "(Moc velký balíček)";
		["UiStackTooSmallError"]	= "(Moc malý balíček)";
	...
	deDE = {
		...
		["OptAuctionDuration"]	= "(last|12h|24h|48h)";
		...
		["CmdAuctionDuration1"]	= "12h";
		["CmdAuctionDuration2"]	= "24h";
		["CmdAuctionDuration3"]	= "48h";
		...
		["GuiAlsoHome"]	= "Daten der eigenen Fraktion werden jetzt ebenefalls angezeigt.";
		["GuiAlsoNeutral"]	= "Daten fuer das neutrale Auktionshaus werden jetzt ebenfalls angezeigt.";
		...
		["UiMinimumBidPercentLabel"]	= "Min.-gebot %";
		["UiMinimumPercentLessShortLabel"]	= "Min. % weniger:";
	...
	enUS = {
		...
		["GuiAlsoHome"]	= "Now also displaying data for the own faction.";
		["GuiAlsoNeutral"]	= "Now also displaying data for the neutral auction house.";
		...
		["UiMinimumBidPercentLabel"]	= "Min Bid %:";
		["UiMinimumPercentLessShortLabel"]	= "Min Pct Less:";
		["UiMinimumProfitLabel"]	= "Minimum Profit:";
	...
	esES = {
		...
		["OptAuctionDuration"]	= "(última|12h|24h|48h)";
	...
	frFR = {
		...
		["OptAuctionDuration"]	= "(court|12h|24h|48h)";
		...
		["AuctionScanAll"]	= "Analyse de toutes les enchères.";
		["AuctionScanAuctions"]	= "Analyse des enchères.";
		["AuctionScanCat"]	= "Analyse de toutes les enchères de %s";
		...
		["FrmtInfoNeverAtAll"]	= "Jamais vu aux enchères";
		...
		["UiMinimumBidPercentLabel"]	= "%offres min:";
		["UiMinimumPercentLessShortLabel"]	= "%min - cher:";
	...
	itIT = {
		...
		["OptAuctionDuration"]	= "(durata||12h||24h||48h)";
	...
	koKR = {
		...
		["FrmtAuctinfoMktprice"]	= "시장가";
		["FrmtAuctinfoNolow"]	= "최근 기록된 정보에서 본 적이 없는 아이템.";
		["FrmtAuctinfoOrig"]	= "원래 입찰가";
		["FrmtAuctinfoSnap"]	= "최근 검색 %d개";
		["FrmtAuctinfoSugbid"]	= "제안 입찰가";
		["FrmtAuctinfoSugbuy"]	= "제안 즉구가";
		["FrmtWarnAbovemkt"]	= "시장가 이상 경합";
		...
		["FrmtMaxBidsReached"]	= "%s (x%d)의 경매품들을 좀더 찾았지만, 입찰 한계(%d)에 도달했습니다.";
		...
		["FrmtAutostart"]	= "%s에 대해 자동으로 경매 시작: 최저가 %s, 즉시 구입가 %s(%d시간)\n%s";
		["FrmtFinish"]	= "검색이 끝나면, %s|1을;를; 수행합니다.";
		["FrmtPrintin"]	= "이제 Auctioneer의 메시지가 \"%s\" 채팅 창에 표시됩니다.";
		...
		["FrmtUnknownRf"]	= "매개변수 ('%s|1')이;')가; 유효하지 않습니다. 매개변수의 형식은 다음과 같아야 합니다: [서버]-[진영]. 예: 달라란-얼라이언스";
		...
		["GuiClearHelp"]	= "Auctioneer 데이터를 삭제합니다.\n모든 데이터 또는 현재 기록을 선택하십시오.\n경고: 삭제된 데이터는 복구할 수 없습니다.";
		...
		["GuiMainHelp"]	= "아이템 정보와 경매 데이타를 분석하여 표시해주는 애드온인 Auctioneer에 대한 설정을 포함합니다. \n경매장에서 경매 데이타를 수집하려면 \"검색\" 버튼을 클릭하십시오.";
		...
		["GuiPercentsHelp"]	= "경고: 다음 설정은 고급 사용자용입니다. \n다음 값들을 조절하여 Auctioneer가 얼마나 적극적으로 이윤 수준을 결정할 것인지를 바꿀수 있습니다.";
		...
		["GuiReloaduiHelp"]	= "설정 화면에 선택한 언어가 반영되도록 지역설정을 바꾼 후에 여기를 클릭해서 WoW UI를 재시작하십시오.\n주의: 이 작업은 몇분 정도 걸릴 수 있습니다.";
		...
		-- Section: Generic Messages
		["ConfirmBidBuyout"]	= "정말로 아래의 가격으로 %s하시겠습니까?\n%d x %s";
		...
		["FrmtInfoAverage"]	= "시작가 %s/ 즉구가 %s (%s에 입찰)";
		["FrmtInfoBidMulti"]	= "입찰가 (%s개당 %s)";
		["FrmtInfoBidOne"]	= "입찰가%s";
		["FrmtInfoBidrate"]	= "입찰 확률 %d%%, 즉구 확률 %d%%";
		["FrmtInfoBuymedian"]	= "즉구가 중앙값";
		["FrmtInfoBuyMulti"]	= "즉구가 (%s개당 %s)";
		["FrmtInfoBuyOne"]	= "즉구가%s";
		["FrmtInfoForone"]	= "개당: 시작 %s/ 즉구 %s (%s 입찰) [%d개중]";
		["FrmtInfoHeadMulti"]	= "평  균: %d개";
		["FrmtInfoHeadOne"]	= "평  균:";
		["FrmtInfoHistmed"]	= "즉구가 중앙값(개당)(최근 기록 %d회)";
		["FrmtInfoMinMulti"]	= "시작가 (개당 %s)";
		["FrmtInfoMinOne"]	= "시작가";
		["FrmtInfoNever"]	= "%s에서 검색된 적 없음";
		["FrmtInfoNeverAtAll"]	= "경매에서 검색된 적 없음";
		["FrmtInfoSeen"]	= "전체 경매 총 %d회 검색";
		["FrmtInfoSgst"]	= "제안가: 시작가 %s/ 즉구가 %s";
		["FrmtInfoSgststx"]	= "제안가: %d개 %s/%s (개당 %s/%s)";
		["FrmtInfoSnapmed"]	= "즉구가 중앙값(개당)(검색 결과 %d회)";
		["FrmtInfoStacksize"]	= "평균 묶음 수량: %d개";

		-- Section: User Interface
		["BuySortTooltip"]	= "즉시 구입 가격순으로 정렬합니다. (아이템 이름 정렬은 SHIFT를 누른 채로 클릭)";
		["ClearTooltip"]	= "검색창의 설정값을 지워줍니다.";
		["FrmtLastSoldOn"]	= "최근 판매가 : %s";
		["RefreshTooltip"]	= "현재 페이지를 다시 검색합니다.";
		["UiBid"]	= "입찰";
		["UiBidHeader"]	= "입찰";
	...
	zhCN = {
		...
		["OptAskPriceSend"]	= "(<玩家名称> <询价查询>)";
		["OptAuctionDuration"]	= "(last最终||12h小时||24h小时||48h小时)";
		["OptBidbroker"]	= "<银币计利润>";
		["OptBidLimit"]	= "<数目>";
		["OptBroker"]	= "<银币计利润>";
		...
		["CmdAuctionDuration1"]	= "12h小时";
		["CmdAuctionDuration2"]	= "24h小时";
		["CmdAuctionDuration3"]	= "48h小时";
		...
		["StatOff"]	= "不显示任何拍卖数据。";
		["StatOn"]	= "显示设定的拍卖数据。";
		["UIScanCanceled"]	= "拍卖助手: 拍卖扫描已取消";
		["UIScanComplete"]	= "拍卖助手: 拍卖扫描已完成";
		...
		["AuctionScanAll"]	= "扫描所有拍卖项.";
		["AuctionScanAuctions"]	= "扫描拍卖项.";
		["AuctionScanCat"]	= "扫描 %s 所有拍卖项";
		...
		["AuctionUpdatedAucts"]	= "更新/修改 拍卖项: %s";
	...
	zhTW = {
		...
		-- Section: Command Messages
		["ConstantsCritical"]	= "危險: 拍賣助手的 SavedVariables 檔案已達到儲存上限的 %.3f%% !";
		["ConstantsMessage"]	= "拍賣助手的 SavedVariables 檔案已達到儲存上限的 %.3f%% ";
		["ConstantsWarning"]	= "警告: 拍賣助手的 SavedVariables 檔案已達到儲存上限的 %.3f%% ";
		...
		["OptAuctionDuration"]	= "(last(上次)|12h(2小時)|24h(8小時)|48h(24小時))";
		["OptBidbroker"]	= "<可得利潤>";
		["OptBidLimit"]	= "<數量>";
		["OptBroker"]	= "<可得利潤>";
		...
		["ScanComplete"]	= "掃描完成";
		["ScanFailed"]	= "掃描失敗";
		["StatAskPriceOff"]	= "詢價功能已停用。";
		["StatAskPriceOn"]	= "詢價功能已啟用。";
		["StatOff"]	= "不顯示任何拍賣資料";
		["StatOn"]	= "顯示設定好的拍賣資料";
		["UIScanCanceled"]	= "拍賣助手: 賣場掃描已被取消";
		["UIScanComplete"]	= "拍賣助手: 賣場掃描已完成";
