...
--   DESCRIPTION = "追蹤過去漁獲及管理你的魚具",    除錯發現 Descript1 2 都是有作用的. XD
   ...
   ID = "FishingBuddy",
   MSGID = "FBAM",   -- Fishing Buddy Addon Message 
...
--   CONFIG_SUITUPFIRST_INFO       = "Put on your fishing outfit if you're not wearing it when the binding key is pressed",
   ...
   LEFTCLICKTODRAG = "按左鍵-拖行",
   RIGHTCLICKFORMENU = "按右鍵-目錄",
   WATCHERCLICKHELP = "#LEFTCLICKTODRAG#\n#RIGHTCLICKFORMENU#",

   MINIMAPBUTTONPLACEMENT = "小地圖按鈕位置",
   MINIMAPBUTTONPLACEMENTTOOLTIP = "讓你可以移動#NAME#圖示在小地圖上的位置",
   CONFIG_MINIMAPBUTTON_ONOFF	= "顯示小地圖按鈕",
   CONFIG_MINIMAPBUTTON_INFO	= "在小地圖上顯示#NAME#的圖示",

   CONFIG_ENHANCESOUNDS_ONOFF      = "增強釣魚音效",
   CONFIG_ENHANCESOUNDS_INFO       = "勾選後, 強化魚標跳動時音效降低環境音效",
   ...
   DASH = " -- ",
   FISHCAUGHT = "%d %s",
   TIMETOGO = "釣魚大賽在 %d:%02d 之後開始",
   TIMELEFT = "釣魚大賽在 %d:%02d 之後結束",
